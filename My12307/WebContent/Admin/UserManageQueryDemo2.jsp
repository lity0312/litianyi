      ...
      <tr>
        ...
        <table width="553" border="1" align="center" cellpadding="0" cellspacing="1" bordercolor="#dadada" bgcolor="#FFFFFF">
          ...
          <c:forEach items="${userList}" var="user" varStatus="status">
            ...
            <c:otherwise>
            <a href="UserManageInfo_Amind_Edit.jsp" class="text_red">编辑</a>
            </c:otherwise>
            </c:choose>
         ...
         <%--  <%
          if(null!=list&&list.size()>0){
            ...
            <td width="247" bordercolor="#FFFFFF"  class="text_cray1">${pageScope.user.cert }</td>
            <td width="82" bordercolor="#FFFFFF"  class="text_cray1">${pageScope.user.userType.content }</td>
            <td width="89" bordercolor="#FFFFFF"  class="text_cray1"><a href="UserManageInfo_Amind_Edit.jsp" class="text_red">编辑</a></td>
          </tr>
        		  <% 
        	  }
          }
          ...
          <tr align="center">
            ...
            <td width="89" bordercolor="#FFFFFF" bgcolor="#F5F5F5"  class="text_cray1"><a href="UserManageInfo_Amind_Edit.jsp" class="text_red">编辑</a></td>
          </tr>
          <tr align="center">
            ...
            <td width="89" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1"><a href="UserManageInfo_Amind_Edit.jsp" class="text_red">编辑</a></td>
          </tr>
          <tr align="center">

<%@ page language="java" contentType="text/html; charset=GB2312"
    pageEncoding="GB2312" import="com.neuedu.util.Constants,com.neuedu.domain.User" %>
...
<table width="100%" border="0" cellspacing="0">
  <tr>
    ...
    <td width="64" align="left" valign="top" bgcolor="#deedf8"><a href="#" onclick="logOut();" target="_self" class="cray">退出</a></td>
  </tr>
</table>

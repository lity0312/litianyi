<%@ page language="java" contentType="text/html; charset=GB2312"
    pageEncoding="GB2312"%>
    <%@ page import="com.neuedu.util.*,com.neuedu.domain.User" %>
  ...
  <tr>
    <td colspan="2"  ><table width="700" border="0" align="center" cellspacing="0">
      <tr>
        ...
        <td align="left" class="text_cray1"><input name="textfield4" type="text" disabled="true" class="text_cray" id="textfield4" value="<%=((User)session.getAttribute(Constants.userKey)).getUserName()%>" size="30" readonly="reasonly"/></td>
      </tr>
      <tr>
        <td width="20" align="center" class="text_red">*</td>
        <td width="100" height="40" class="text_cray1">原密码：</td>
        <td align="left" class="text_cray1"><input name="oldPwd" type="text" class="text_cray" id="oldPwd" size="30" /></td>
      </tr>
      <tr>
        <td width="20" align="center"  class="text_red">*</td>
        <td width="100" height="40" class="text_cray1">新密码：</td>
        <td align="left" class="text_cray1"><input name="pwd" type="text" class="text_cray" id="pwd" size="30" /></td>
      </tr>
      <tr>
        <td width="20" align="center" class="text_red">*</td>
        <td width="100" height="40" class="text_cray1">确认新密码：</td>
        <td align="left" class="text_cray1"><input name="pwd2" type="text" class="text_cray" id="pwd2" size="30" /></td>
      </tr>
    </table>
      <br></td>
  </tr>
...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="78" align="left"><input name="button" type="button" class="buttj" id="button"value="" onclick="doSave();"></td>
